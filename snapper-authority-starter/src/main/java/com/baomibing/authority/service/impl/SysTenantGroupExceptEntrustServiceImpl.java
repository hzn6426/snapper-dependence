...
import com.baomibing.authority.dto.SysTenantGroupExceptEntrustDto;
import com.baomibing.authority.entity.SysTenantGroup;
import com.baomibing.authority.entity.SysTenantGroupExceptEntrust;
import com.baomibing.authority.mapper.SysTenantGroupExceptEntrustMapper;
import com.baomibing.authority.service.SysTenantGroupExceptEntrustService;
...
/**
 * SysTenantGroupExceptEntrustServiceImpl
 *
 * @author zening
 * @version 1.0.0
 **/
@Service
public class SysTenantGroupExceptEntrustServiceImpl extends MBaseServiceImpl<SysTenantGroupExceptEntrustMapper, SysTenantGroupExceptEntrust, SysTenantGroupExceptEntrustDto> implements SysTenantGroupExceptEntrustService {
    ...
    public List<SysTenantGroupDto> listEntrustGroupsByGroupAndUserAndPerm(String tenantId, String orgId, String userId, String permId) {
        ...
        if(Checker.beNull(permId) || Checker.beEmpty(userId) || Checker.beEmpty(tenantId) || Checker.beEmpty(orgId)) {
            return emptyList;
        }
