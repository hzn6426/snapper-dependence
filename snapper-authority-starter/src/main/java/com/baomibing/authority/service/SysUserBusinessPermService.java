...
//	BusinessPermScopeEnum getUserBusinessByMethodAndUrl(String orgId, String userId, String method, String url);
    ...
    /**
     * 根据组织及用户获取用户在该组织下的权限信息
     * @param userIds 用户 ID列表
     * @param orgId  组织ID(用户当前选择组织)
     */
    List<UserBusinessPermDto> listUserBusinessPerms( Set<String> userIds, String orgId);
     ...
     */
    void doCopyUserBusinessPerm(String uid, String gid, String toUserId);
}
