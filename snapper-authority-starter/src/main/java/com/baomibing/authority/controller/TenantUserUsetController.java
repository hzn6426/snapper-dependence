...
@RequestMapping(path = "/eapi/userUset", consumes = { "application/json", "application/x-www-form-urlencoded" }, produces = MediaType.APPLICATION_JSON_VALUE)
@RestController
public class TenantUserUsetController extends MBaseController<SysTenantUserUsetDto> {
