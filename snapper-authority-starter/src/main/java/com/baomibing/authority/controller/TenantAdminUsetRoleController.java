 ...
 * @version 1.0.0
 */
@RequestMapping(path = "/api/tusetRole", consumes = {"application/json", "application/x-www-form-urlencoded"}, produces = MediaType.APPLICATION_JSON_VALUE)
@RestController
public class TenantAdminUsetRoleController extends MBaseController<SysTenantUsetRoleDto> {
