...
@RequestMapping(path = "/api/tuserRole", consumes = {"application/json", "application/x-www-form-urlencoded"}, produces = MediaType.APPLICATION_JSON_VALUE)
@RestController
public class TenantAdminUserRoleController extends MBaseController<SysTenantUserRoleDto> {
