 ...
 * @since: 1.0.0
 */
@RequestMapping(path = "/api/tuset", consumes = {"application/json", "application/x-www-form-urlencoded"}, produces = MediaType.APPLICATION_JSON_VALUE)
@RestController
public class TenantAdminUsetController extends MBaseController<SysTenantUsetDto> {
	@Autowired
