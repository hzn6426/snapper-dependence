...
@RestController
@RequestMapping(path = "/eapi/position", consumes = {"application/json", "application/x-www-form-urlencoded"}, produces = MediaType.APPLICATION_JSON_VALUE)
public class TenantPositionController extends MBaseController<SysTenantPositionDto> {
