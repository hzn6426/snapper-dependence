...
/**
 * DefaultSpiBusinessTenantAuthService
 *
 * @author zening 2024/12/30 14:45
 * @version 1.0.0
 **/
@AutoService(value = BusinessTenantAuthService.class)
public class DefaultSpiBusinessTenantAuthService implements BusinessTenantAuthService  {

    private CommonBusinessTenantAuthService getBusinessAuthApi() {
        return ApplicationContextHandler.getBean(CommonBusinessTenantAuthService.class);
    }
    @Override
    public TenantEntrustWarpper getEntrustBusinessPerm(TenantUser user, String permId, String scope, boolean beIgnoreUserScope, boolean beIgnoreGroupScope) {
