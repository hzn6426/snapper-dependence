...
public interface SysTenantGroupExceptEntrustMapper extends BaseMapper<SysTenantGroupExceptEntrust> {
     ...
     * @return
     */
    List<SysTenantGroup> listEntrustGroupsByGroupAndUserAndPerm(@Param("tenantId") String tenantId, @Param("orgId") String orgId, @Param("userId") String userId,
