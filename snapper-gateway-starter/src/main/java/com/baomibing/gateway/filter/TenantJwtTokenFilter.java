 ...
 */
@Slf4j
public class TenantJwtTokenFilter extends BaseFilter implements GlobalFilter, Ordered {

    public TenantJwtTokenFilter withTestUser(TestUser user) {
        this.testUser = user;
        return this;
    }
