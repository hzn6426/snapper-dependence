 ...
 * @version 1.0.0
 */
public interface BusinessTenantAuthService {
     ...
     * @return
     */
    TenantEntrustWarpper getEntrustBusinessPerm(TenantUser user, String permId, String scope, boolean beIgnoreUserScope, boolean beIgnoreGroupScope);
