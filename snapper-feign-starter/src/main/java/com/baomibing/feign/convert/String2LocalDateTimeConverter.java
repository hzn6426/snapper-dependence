...
public class String2LocalDateTimeConverter extends BaseDateConverter implements Converter<String, LocalDateTime> {
    ...
    public String2LocalDateTimeConverter() {
        ...
        map.put(DEFAULT_DATE_TIME_FORMAT, DEFAULT_DATE_TIME_FORMAT_MATCHES)
